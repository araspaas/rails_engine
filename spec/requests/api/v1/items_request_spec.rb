...
describe "Items API" do
  it "sends a list of items" do
    ...
    expect(items.first).to be_instance_of(Hash)
  ...
  it "can create a new item" do
    ...
    item_params = {
                    "name": "G.I Joe",
                    "description": "His name isn't Joe though",
    ...
    expect(response["data"]["attributes"]["name"]).to eq("G.I Joe")
    expect(response["data"]["attributes"]["description"]).to eq("His name isn't Joe though")
  end
